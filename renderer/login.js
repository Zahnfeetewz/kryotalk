...
registerForm.addEventListener('submit', async (e) => {
  ...
  if (result.devMode) {
    ...
    document.getElementById('verify-dev-code').textContent = t('devModeCode') + (result.devCode || '');
  } else {
    document.getElementById('verify-dev-code').style.display = 'none';
  ...
  if (result.devCode && !result.devMode) {
    document.getElementById('verify-dev-code').style.display = 'block';
    document.getElementById('verify-dev-code').textContent = t('devModeCode') + result.devCode;
  }
...
document.getElementById('forgot-submit1')?.addEventListener('click', async () => {
  ...
  try {
    ...
    document.getElementById('forgot-email-masked').textContent = result.email;
